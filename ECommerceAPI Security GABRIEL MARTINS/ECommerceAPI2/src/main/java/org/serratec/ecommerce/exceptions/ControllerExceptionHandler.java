...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleEmailException(EmailException e, WebRequest request) {
		List<String> erros = new ArrayList<>();
    ...
    public ResponseEntity<Object> handleStatusPedidoInvalidoException(StatusPedidoInvalidoException ex, WebRequest request) {
